...
ds_mods_setup="$HOME/.klei/DoNotStarveTogether/Cluster/mods/dedicated_server_mods_setup.lua"
if [ -f "$ds_mods_setup" ]
then
...
./dontstarve_dedicated_server_nullrenderer -cluster Cluster -shard "$SHARD_NAME"
